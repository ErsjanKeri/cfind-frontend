...
import { MapPin, TrendingUp, Users, Clock, Eye, Heart } from "lucide-react"
...
export function ListingCard({ listing }: ListingCardProps) {
  ...
  const handleSave = (e: React.MouseEvent) => {
    ...
    setIsSaved(!isSaved)
    // In a real app, this would call an API to save/unsave the listing
  }
          ...
          <div className="mt-4 grid grid-cols-3 gap-3 pt-4 border-t border-border">
            <div className="text-center">
              ...
              <p className="text-sm font-semibold text-foreground mt-0.5">
                {formatCurrency((currency === "EUR" ? listing.monthly_revenue_eur : listing.monthly_revenue_lek) || 0, currency)}/mo
              </p>
            </div>
