...
export function DemandCard({
    ...
    const getCategoryLabel = (category: string) => {
        const cat = businessCategories.find((c) => c.value === category)
        ...
        <Card className="hover:border-primary/30 transition-colors">
            <CardHeader className="pb-3">
                <div className="flex items-start justify-between">
                    ...
                    <Badge className={statusColors[demand.status] || statusColors.active}>
            ...
            <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="font-medium">
                        {formatCurrency(
                            currency === "EUR" ? demand.budget_min_eur : demand.budget_min_lek,
                            currency
                        )} - {formatCurrency(
                            currency === "EUR" ? demand.budget_max_eur : demand.budget_max_lek,
                            currency
                        )}
                    </span>
                </div>
