            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    {premiumListings.map((listing) => (
                        <PremiumListingCard key={listing.id} listing={listing} getCategoryLabel={getCategoryLabel} />
                    ))}
                </div>
...
function PremiumListingCard({ listing, getCategoryLabel }: PremiumListingCardProps) {
    // For simplicity, using EUR - in real app would use user preference
