...
export function PromoteListingDialog({
    ...
    const getFeaturedConfig = () => tierConfigs.find((c: PromotionTierConfig) => c.tier === "featured")
    const getPremiumConfig = () => tierConfigs.find((c: PromotionTierConfig) => c.tier === "premium")
    ...
    const getEffectiveCost = (tier: "featured" | "premium"): number => {
        ...
        if (currentTier === "featured" && tier === "premium") {
            ...
            return config.credit_cost - (featuredConfig?.credit_cost || 0)
        }

        return config.credit_cost || 0
    }
                ...
                {isLoading ? (
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid gap-4 sm:grid-cols-2">
                            {([getFeaturedConfig(), getPremiumConfig()].filter(Boolean) as PromotionTierConfig[]).map((config) => {
                        ...
                        <div className="flex justify-end gap-3 pt-4">
                            ...
                            <LoadingButton
                                ...
                                isLoading={promoteListing.isPending}
